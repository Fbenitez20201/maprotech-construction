...
export default function Footer() {
  ...
  return (
    <footer ref={ref} className="bg-black font-sans">
      <div className="relative min-h-[70vh] flex flex-col">
        ...
        <div className="relative z-10 flex-1 flex flex-col max-w-[1400px] mx-auto px-6 lg:px-10 w-full py-12">
          ...
          >
            ...
            <Link
              href="/contact"
              className="inline-block px-8 py-3.5 bg-white text-black text-sm font-medium rounded-full hover:bg-gray-200 transition-colors"
            >
              {t("hero.cta")}
            </Link>
          </motion.div>
      ...
      <div className="bg-black pt-16 lg:pt-24 pb-0 overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-20">
            ...
            >
              <h3 className="text-white text-xl md:text-2xl font-bold leading-snug mb-4 max-w-sm">
                {language === "en"
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  className="w-10 h-10 rounded-full border border-gray-800 flex items-center justify-center text-white hover:border-white transition-all"
                >
                  <svg
                    className="w-4 h-4"
                    fill="currentColor"
              ...
              <nav className="flex flex-col space-y-4">
                {navLinks.map((link) => (
                  <Link
                    key={link.name}
                    href={link.href}
                    className="text-white text-lg font-bold hover:text-gray-400 transition-colors w-fit"
                  >
                    {link.name}
                  </Link>
                ))}
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 py-8 border-t border-[#1A1A1A] text-sm relative z-10">
        ...
        <motion.div
          ...
          className="relative w-full flex justify-center items-end mt-4"
        >
          <div className="relative w-full h-[25vh] md:h-[45vh] lg:h-[55vh] translate-y-[15%]">
            <Image
